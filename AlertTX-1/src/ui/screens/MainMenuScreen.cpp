...
void MainMenuScreen::draw() {
    Serial.println("MainMenuScreen: Drawing...");
    if (!renderer || !needsRedraw()) {
        Serial.println("  - Skipping draw (no renderer or no redraw needed)");
        return;
    }
    ...
    clearRedrawFlag();
    Serial.println("MainMenuScreen: Draw complete");
}
...
void MainMenuScreen::onAlertsSelected() {
    Serial.printf("Alerts menu selected at %lu ms\n", millis());
